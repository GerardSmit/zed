...
pub(super) fn to_shape(style: CursorStyle) -> Shape {
    match style {
        ...
        CursorStyle::ResizeUp | CursorStyle::ScrollUp => Shape::NResize,
        CursorStyle::ResizeDown | CursorStyle::ScrollDown => Shape::SResize,
        CursorStyle::ResizeUpDown | CursorStyle::ScrollUpDown => Shape::NsResize,
