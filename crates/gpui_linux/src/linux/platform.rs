...
pub(super) fn cursor_style_to_icon_names(style: CursorStyle) -> &'static [&'static str] {
    ...
    match style {
        ...
        CursorStyle::ResizeUp | CursorStyle::ScrollUp => &["n-resize", "top_side"],
        CursorStyle::ResizeDown | CursorStyle::ScrollDown => &["s-resize", "bottom_side"],
        CursorStyle::ResizeUpDown | CursorStyle::ScrollUpDown => &["sb_v_double_arrow", "ns-resize"],
